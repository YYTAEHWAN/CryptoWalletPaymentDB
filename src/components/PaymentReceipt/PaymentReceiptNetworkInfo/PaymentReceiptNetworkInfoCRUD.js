...
const NetworkInfoDB = {
  async create(payment_receipt_idx, payment_wallet_name, main_blockchain_name, detailed_network_name, detailed_network_id) {
    try {
      const doc = await db
  ...
  async update(payment_receipt_idx, payment_wallet_name, main_blockchain_name, detailed_network_name, detailed_network_id) {
    try {
      const doc = await db
        .collection('payment_receipt_network_info')
        .doc(String(payment_receipt_idx))
